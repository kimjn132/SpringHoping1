		 	...
		 	<div class="col" style="margin: 20px;">
				...
				<form action="ClientModify.do" method="post">
					<table>
						...
						<tr>
							<th>이름</th>
							<td><input type="text" name="cName" size="40" value="${mypageview.cName}"></td>
						</tr>
						<tr>
							<th>전화번호</th>
							<th><input type="text" name="cPhone" size="40"  value="${mypageview.cPhone}"> </th>
						</tr>
						<tr>
							<th>이메일</th>
							<td><input type="text" name="cEmail" size="40"  value="${mypageview.cEmail}"></td>
						</tr>

						<tr>
							<th>주소</th>
							<td><input type="text" id="sample4_postcode" placeholder="우편번호" name="zonecode" readonly="readonly" value="${mypageview.zonecode}">
								 <input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
								<input type="text" id="sample4_roadAddress" placeholder="도로명주소" name="address"  value="${mypageview.address}"><br>
								<input type="text" id="sample4_jibunAddress" placeholder="빌딩이름" name="buildingName"  value="${mypageview.buildingName}">
								<input type="text" id="sample4_detailAddress" placeholder="상세주소" name="detailAddress"  value="${mypageview.detailAddress}"></td>
						</tr>
					
					
					<tr>
					<td></td><td><input type="submit" value="수정" class="btn btn-primary" style="margin: 10px;">
